...
def print_banner():
    ...
    print("║       Dev/Creator: muttahar123                                  ║")
    print("║       GitHub: https://github.com/muttahar123                   ║")
    print("╚══════════════════════════════════════════════════════════════╝")
    print("\033[0m")
...
def compose_frame(frame, results, tracker, frame_idx, total_frames, fps):
    ...
    # watermark
    txt(output,"muttahar123 | github.com/muttahar123",(w-268,h-18),(60,60,100),0.35)
